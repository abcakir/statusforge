    ...
    <div className="space-y-6">
      ...
      {showForm && (
        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow p-6 space-y-4">
          ...
          <input type="number" className="w-full border rounded px-3 py-2 text-sm" placeholder="Check interval (seconds)" value={form.check_interval} onChange={(e) => setForm((f) => ({ ...f, check_interval: Number(e.target.value) }))} />
